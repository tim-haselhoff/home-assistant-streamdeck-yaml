...
class Config(BaseModel):
    ...
    def load(cls: type[Config], fname: Path) -> Config:
        ...
        with fname.open() as f:
            ...
            if not config.asset_path.is_dir():
                raise FileNotFoundError(f"Asset directory {config.asset_path} not found")
...
def _init_icon(
    *,
    ...
    if icon_filename is not None:
        ...
        path = icon_path if icon_path.is_absolute() else Config.get_instance().asset_path / icon_path
